...
export interface AsExpressionNode extends BaseTypedNode {
  kind: 234; // AsExpression
  
  // TODO: 添加AsExpression特定属性
 ...
 * 类型判定函数
 */
export function isAsExpression(node: BaseTypedNode): node is AsExpressionNode {
