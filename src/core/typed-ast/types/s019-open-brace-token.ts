...
export interface OpenBraceTokenNode extends BaseTypedNode {
  kind: 19; // OpenBraceToken
  
  // TODO: 添加OpenBraceToken特定属性
 ...
 * 类型判定函数
 */
export function isOpenBraceToken(node: BaseTypedNode): node is OpenBraceTokenNode {
  return node.kind === 19;
}
