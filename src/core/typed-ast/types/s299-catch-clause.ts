...
export interface CatchClauseNode extends BaseTypedNode {
  kind: 299; // CatchClause
  
  // TODO: 添加CatchClause特定属性
 ...
 * 类型判定函数
 */
export function isCatchClause(node: BaseTypedNode): node is CatchClauseNode {
