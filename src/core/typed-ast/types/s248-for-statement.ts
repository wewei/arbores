...
export interface ForStatementNode extends BaseTypedNode {
  kind: 248; // ForStatement
  
  // TODO: 添加ForStatement特定属性
 ...
 * 类型判定函数
 */
export function isForStatement(node: BaseTypedNode): node is ForStatementNode {
