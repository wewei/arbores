...
export interface IfStatementNode extends BaseTypedNode {
  kind: 245; // IfStatement
  
  // TODO: 添加IfStatement特定属性
 ...
 * 类型判定函数
 */
export function isIfStatement(node: BaseTypedNode): node is IfStatementNode {
