...
export interface CallExpressionNode extends BaseTypedNode {
  kind: 213; // CallExpression
  
  // TODO: 添加CallExpression特定属性
 ...
 * 类型判定函数
 */
export function isCallExpression(node: BaseTypedNode): node is CallExpressionNode {
