...
export interface NeverKeywordNode extends BaseTypedNode {
  kind: 146; // NeverKeyword
  
  // TODO: 添加NeverKeyword特定属性
 ...
 * 类型判定函数
 */
export function isNeverKeyword(node: BaseTypedNode): node is NeverKeywordNode {
