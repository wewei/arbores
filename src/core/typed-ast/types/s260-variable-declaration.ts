...
export interface VariableDeclarationNode extends BaseTypedNode {
  kind: 260; // VariableDeclaration
  
  // TODO: 添加VariableDeclaration特定属性
 ...
 * 类型判定函数
 */
export function isVariableDeclaration(node: BaseTypedNode): node is VariableDeclarationNode {
