...
export interface StaticKeywordNode extends BaseTypedNode {
  kind: 126; // StaticKeyword
  
  // TODO: 添加StaticKeyword特定属性
 ...
 * 类型判定函数
 */
export function isStaticKeyword(node: BaseTypedNode): node is StaticKeywordNode {
