...
export interface TypeParameterNode extends BaseTypedNode {
  kind: 168; // TypeParameter
  
  // TODO: 添加TypeParameter特定属性
 ...
 * 类型判定函数
 */
export function isTypeParameter(node: BaseTypedNode): node is TypeParameterNode {
