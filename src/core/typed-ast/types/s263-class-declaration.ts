...
export interface ClassDeclarationNode extends BaseTypedNode {
  kind: 263; // ClassDeclaration
  
  // TODO: 添加ClassDeclaration特定属性
 ...
 * 类型判定函数
 */
export function isClassDeclaration(node: BaseTypedNode): node is ClassDeclarationNode {
