...
export interface SpreadElementNode extends BaseTypedNode {
  kind: 230; // SpreadElement
  
  // TODO: 添加SpreadElement特定属性
 ...
 * 类型判定函数
 */
export function isSpreadElement(node: BaseTypedNode): node is SpreadElementNode {
