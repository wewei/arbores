...
export interface TemplateTailNode extends BaseTypedNode {
  kind: 18; // TemplateTail
  
  // TODO: 添加TemplateTail特定属性
 ...
 * 类型判定函数
 */
export function isTemplateTail(node: BaseTypedNode): node is TemplateTailNode {
  return node.kind === 18;
}
