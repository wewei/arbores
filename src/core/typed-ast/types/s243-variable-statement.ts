...
export interface VariableStatementNode extends BaseTypedNode {
  kind: 243; // VariableStatement
  
  // TODO: 添加VariableStatement特定属性
 ...
 * 类型判定函数
 */
export function isVariableStatement(node: BaseTypedNode): node is VariableStatementNode {
