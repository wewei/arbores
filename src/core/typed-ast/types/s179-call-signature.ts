...
export interface CallSignatureNode extends BaseTypedNode {
  kind: 179; // CallSignature
  
  // TODO: 添加CallSignature特定属性
 ...
 * 类型判定函数
 */
export function isCallSignature(node: BaseTypedNode): node is CallSignatureNode {
