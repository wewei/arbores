...
export interface ArrowFunctionNode extends BaseTypedNode {
  kind: 219; // ArrowFunction
  
  // TODO: 添加ArrowFunction特定属性
 ...
 * 类型判定函数
 */
export function isArrowFunction(node: BaseTypedNode): node is ArrowFunctionNode {
