...
export interface ReturnStatementNode extends BaseTypedNode {
  kind: 253; // ReturnStatement
  
  // TODO: 添加ReturnStatement特定属性
 ...
 * 类型判定函数
 */
export function isReturnStatement(node: BaseTypedNode): node is ReturnStatementNode {
