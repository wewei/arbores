...
export interface FunctionTypeNode extends BaseTypedNode {
  kind: 184; // FunctionType
  
  // TODO: 添加FunctionType特定属性
 ...
 * 类型判定函数
 */
export function isFunctionType(node: BaseTypedNode): node is FunctionTypeNode {
