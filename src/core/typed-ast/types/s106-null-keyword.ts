...
export interface NullKeywordNode extends BaseTypedNode {
  kind: 106; // NullKeyword
  
  // TODO: 添加NullKeyword特定属性
 ...
 * 类型判定函数
 */
export function isNullKeyword(node: BaseTypedNode): node is NullKeywordNode {
