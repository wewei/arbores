...
export interface JsxTextAllWhiteSpacesNode extends BaseTypedNode {
  kind: 13; // JsxTextAllWhiteSpaces
  
  // TODO: 添加JsxTextAllWhiteSpaces特定属性
 ...
 * 类型判定函数
 */
export function isJsxTextAllWhiteSpaces(node: BaseTypedNode): node is JsxTextAllWhiteSpacesNode {
  return node.kind === 13;
}
