...
export interface MetaPropertyNode extends BaseTypedNode {
  kind: 236; // MetaProperty
  
  // TODO: 添加MetaProperty特定属性
 ...
 * 类型判定函数
 */
export function isMetaProperty(node: BaseTypedNode): node is MetaPropertyNode {
