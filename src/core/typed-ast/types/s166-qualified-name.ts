...
export interface QualifiedNameNode extends BaseTypedNode {
  kind: 166; // QualifiedName
  
  // TODO: 添加QualifiedName特定属性
 ...
 * 类型判定函数
 */
export function isQualifiedName(node: BaseTypedNode): node is QualifiedNameNode {
