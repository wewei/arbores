...
export interface StringKeywordNode extends BaseTypedNode {
  kind: 154; // StringKeyword
  
  // TODO: 添加StringKeyword特定属性
 ...
 * 类型判定函数
 */
export function isStringKeyword(node: BaseTypedNode): node is StringKeywordNode {
