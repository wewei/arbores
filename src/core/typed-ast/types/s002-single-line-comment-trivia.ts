...
export interface SingleLineCommentTriviaNode extends BaseTypedNode {
  kind: 2; // SingleLineCommentTrivia
  
  // TODO: 添加SingleLineCommentTrivia特定属性
 ...
 * 类型判定函数
 */
export function isSingleLineCommentTrivia(node: BaseTypedNode): node is SingleLineCommentTriviaNode {
  return node.kind === 2;
}
